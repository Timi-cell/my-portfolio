  ...
  return (
    <div className="px-8 py-0 flex flex-col-reverse items-center justify-center flex-nowrap gap-5 text-center lg:justify-between lg:text-left lg:flex-row lg:gap-10">
      <div className="flex flex-col items-center justify-between gap-4 lg:block">
        ...
        <p className="text-gray-500 text-xl lg:text-2xl mt-3 dark:text-white">
        ...
        <div className="mt-3 flex flex-row items-center justify-start flex-nowrap gap-3">
          <a href="#projects"><Button size="lg">My Projects</Button></a>
          <a href="#contact">
      ...
      <img className="object-cover w-3/4 lg:w-4/12" src={Img} alt="profilePic" />
    </div>
  );
};
